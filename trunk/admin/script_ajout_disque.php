...
if (!$clexiste) {     // le code-lettres n'existe pas... 
  ...
  echo 'Pour cr&eacute;er ce code-lettres,&nbsp;<a href="ajouter_artiste.php?codelettres=' ;
  ...
  if (0!=$result) {     // bien rentré dans la base
    ...
    echo '<br><br><br><a href="modifier_disque.php?codelettres='.$codelettres.'&&numero='.$compteur.'">' ;
    echo "Modifier ces param&egrave;tres</a>\n" ;
    echo '<p><br><br><a href="ajouter_disque.php?categorie='.$categorie.'">Ajouter un autre disque</a>'."\n" ;
    echo '<br><a href="ajouter_disque.php?codelettres='.$codelettres.'&&categorie='.$categorie.'">Ajouter un disque du m&ecirc;me auteur</a>'."\n" ;
    echo '<br><br><a href="ajouter_artiste.php">Ajouter un nouvel artiste</a></center>' ;
  }
