<?php
  ...
  if ($row=mysql_fetch_row($result)) {
    ...
    echo ".\n<br>".'<a href="ajouter_client.php">Ajouter un autre client</a><br>' ;
    die('</center>') ;
  }
  ...
  if (0!=$result) {     // bien rentré dans la base
    ...
    echo '<br><br><a href="modifier_client.php?trigramme='.$trigramme.'">' ;
    echo "Modifier ces param&egrave;tres</a>\n" ;

    echo '<p><br><br><a href="traiter_client.php?trigramme='.$trigramme.'">Traiter le client</a>'."\n" ;
    echo '<br><a href="ajouter_client.php">Ajouter un autre client</a></center>' ;
  }
