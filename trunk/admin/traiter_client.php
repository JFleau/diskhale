        ...
        if ($row = mysql_fetch_row($result)) {
          ...
          if ($nbemprunts<$nbmax) {
            ...
            if ($row = mysql_fetch_row($result)) {
              ...
              echo $row[0]."<br>\n" ;
              echo '<a href="traiter_client.php?trigramme='.$trigramme.'">Retour</a></center>' ;
              die($finpage) ;
            }
            else  {               
          ...
          echo '<a href="traiter_client.php">Retour</a></center>' ;
          die($finpage) ;
        }
      }
      else {
        echo '<br><center>Disque inexistant, op&eacute;ration impossible<br>' ;
        echo '<a href="traiter_client.php?trigramme='.$trigramme.'">Retour</a><br></center>' ;
        die($finpage) ; 
      }
    } 
  }
...
<form action="traiter_client.php" method=post>
...
<?php
  ...
  // PAGE GENEREE SI UN TRIGRAMME EST PROPOSE 
    ...
    if ($row = mysql_fetch_row($result)) {
      ...
      echo '<form action="traiter_client.php?emprunter=1&&trigramme='.$trigramme.'" method=post>' ;      
	...
	echo $duree_emprunt.'<td>';
        echo '<a href="traiter_client.php?trigramme='.$trigramme.'&&rendre=1&&codelettres='.$row[0].'&&numero='.$row[1].'">' ;
        echo 'rendre</a>' ;
        echo "\n</tr>\n" ;        
      }
      ...
      echo '<center><br>Aucun client trouv&eacute; pour ce trigramme.<br><a href="traiter_client.php">Retour</a></center>' ;
    }
?>
