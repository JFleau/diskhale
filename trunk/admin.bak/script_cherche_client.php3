...
<?php
  ...
  while ($row=mysql_fetch_row($result)) {
    ...
    echo '<tr><td>' ;
    echo '<a href="modifier_client.php3?trigramme='.$row[0].'">&nbsp;M&nbsp;</a><td>' ;
    echo '<a href="traiter_client.php3?trigramme='.$row[0].'">&nbsp;T&nbsp;</a><td>' ;
    echo '<a href="script_effacer_client.php3?trigramme='.$row[0].'">&nbsp;X&nbsp;</a><td>' ;
  ...
  echo "<br><br><br>\n" ;
  echo '<a href="chercher_client.php3">Retour aux crit&egrave;res de recherche</a><br>'."\n" ;
