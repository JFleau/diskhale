<?php
  ...
  if ($row=mysql_fetch_row($result)) {
    ...
    echo ".\n<br>".'<a href="ajouter_artiste.php3">Ajouter un autre artiste</a><br>' ;
    die('</center>') ;
  }
  ...
  if (0!=$result) {     // bien rentré dans la base
    ...
    echo "<br>\n</table>\n" ;
    echo '<br><br><a href="modifier_artiste.php3?codelettres='.$codelettres.'">' ;
    echo "Modifier ces param&egrave;tres</a>\n" ;
    echo '<br><br>' ;
    echo '<br><a href="ajouter_disque.php3?codelettres='.$codelettres.'&&categorie='.$categorie.'">Ajouter un disque</a>' ;
    echo '<br><a href="ajouter_artiste.php3">Ajouter un autre artiste</a></center>' ;
  }
