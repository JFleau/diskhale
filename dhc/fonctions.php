...
function emprunter($trigramme){
		...
		$query3="SELECT * FROM `emprunts` WHERE (`codelettres`,`numero`,`categorie`,`trigramme`,`daterendu`) = ('".$codeajout."','".$numeroajout."','".$cat2."','".$trigramme."','0000-00-00')";
		$result3=mysql_query($query3);
		$nombre3=mysql_num_rows($result3);
		if ($nombre3!=0) return "Erreur. Vous avez déjà emprunté ce disque.";
		...
		else return "Vous ne pouvez pas posséder plus de 5 disques simultanément.";
}
	?>	