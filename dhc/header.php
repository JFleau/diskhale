    ...
    <a href="accueil_recherche.php?page=inscription"><img src="images/inscription_unselect.png" style="float:right; padding-top:10px;" onMouseOver="this.src=\'images/inscription_hover.png\'" onMouseOut="this.src=\'images/inscription_unselect.png\'" /></a>
	...
	if ($page=="inscription") {
	echo '
	<a href="accueil_recherche.php?page=recherche"><img src="images/recherche_unselect.png" style="float:right; padding-top:10px;" onmouseover="this.src=\'images/recherche_hover.png\'" onmouseout="this.src=\'images/recherche_unselect.png\'"/></a>
